...
i1 = Ingredient.create(ingredientname: "Whiskey", liquortype: "Achohol", description: "A type of distilled alcoholic beverage made from fermented grain mash. Various grains are used for different varieties, including barley, corn, rye, and wheat.", image: "JD_Whiskey_1.jpg")
